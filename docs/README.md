...
I created this because I didn't want to add events to a shared calendar for me and my friends any longer. And it's also a great way to test out how beneficial AI is in coding via dialogue with ChatGPT, and an excuse to utilize the OpenAI API.
